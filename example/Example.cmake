...
# ==============================================================
  ...
  ENDIF()
   ...
   IF (ADD_FATAL_EXAMPLE)
      ...
      target_link_libraries(g3log-FATAL-contract PRIVATE ${G3LOG_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
      target_link_libraries(g3log-FATAL-sigsegv PRIVATE ${G3LOG_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
      target_link_libraries(g3log-FATAL-choice PRIVATE ${G3LOG_LIBRARY} ${EXAMPLE_PLATFORM_LINK_LIBRIES})
   ELSE()
